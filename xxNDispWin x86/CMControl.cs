        ...
        public bool ReadInifile(string FileName, string SectionName)
            {
                ...
                try
                {
                    ...
                    if (AxisName == "GX" || AxisName == "GY")
                        HomeMode = (EHomeMode)Inifile.ReadInteger(SectionName, "HomeMode", (int)EHomeMode.MODE13_LmtSearchReFind);//MODE8_LmtSearch);
                    else
                        HomeMode = (EHomeMode)Inifile.ReadInteger(SectionName, "HomeMode", (int)EHomeMode.MODE12_AbsSearchReFind);//EHomeMode.MODE7_AbsSearch);
                }
                catch { throw; };
