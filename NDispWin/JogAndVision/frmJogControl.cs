...
namespace NDispWin
{
    public partial class frmJogControl : Form
    {
        ...
        private void frmJogControl_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        TLightRGBA oldRGBA = new TLightRGBA();
        TLightRGBA newRGBA = new TLightRGBA();
        ...
        {
            oldRGBA = TaskVision.CurrentLightRGBA;
        }
        private void tbar_R_MouseUp(object sender, MouseEventArgs e)
        {
            newRGBA = TaskVision.CurrentLightRGBA;
            string s = "{" + oldRGBA.R.ToString() + "," + oldRGBA.G.ToString() + "," + oldRGBA.B.ToString() + "," + oldRGBA.A.ToString() + "}";
            string ns = "{" + newRGBA.R.ToString() + "," + newRGBA.G.ToString() + "," + newRGBA.B.ToString() + "," + newRGBA.A.ToString() + "}";
